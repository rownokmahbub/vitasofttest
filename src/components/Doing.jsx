...
export default function Doing() {
  ...
  return (
   ...
   <div className="flex justify-between items-center bg-white border rounded-lg border-l-4 border-amber-500 px-4 py-2.5">
    <div className="flex items-center gap-2">
    <h3 className="text-base font-semibold">Doing</h3>
