...
export default function Todos() {
  ...
  return (
    <div className="container mx-auto flex flex-col gap-5 mt-5 bg-gradient-to-r from-stone-50 to-slate-50 px-4 py-4 rounded-xl border">
   <div className="flex justify-between items-center bg-white border rounded-lg border-l-4 border-cyan-500 px-4 py-2.5">
